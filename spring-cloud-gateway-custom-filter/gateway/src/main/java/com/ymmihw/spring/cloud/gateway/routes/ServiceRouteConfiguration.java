package com.ymmihw.spring.cloud.gateway.routes;

import org.springframework.cloud.gateway.route.RouteLocator;
import org.springframework.cloud.gateway.route.builder.RouteLocatorBuilder;
import org.springframework.context.annotation.Bean;
import com.ymmihw.spring.cloud.gateway.filters.factories.LoggingGatewayFilterFactory;
import com.ymmihw.spring.cloud.gateway.filters.factories.LoggingGatewayFilterFactory.Config;
...
public class ServiceRouteConfiguration {
  ...
  public RouteLocator routes(RouteLocatorBuilder builder,
    ...
    return builder.routes()
        .route("service_route_java_config",
            r -> r.path("/service/**")
